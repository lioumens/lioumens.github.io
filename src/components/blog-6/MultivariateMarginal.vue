...
<template>
    <div class="bivariate-marginal-applet">
        ...
        <VBtn class="marginal-animation-control" variant="text" @click="togglePlay()">{{ isPlaying ? "Pause" : "Play" }}</VBtn>
        </div>
...
<p>The proportionality constant here is <Katex src="\frac{1}{\sigma_{\tiny Y|X} \sqrt{2\pi}}"></Katex></p>
</div>
