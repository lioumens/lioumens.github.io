...
<template>
  <div style="height: 50px">
    ...
    <figcaption style="margin: 0px; color:#b0b0b0;font-size:.9rem;">Animation composition behaves oddly in safari 16 (and iPhone), still hacking a work around.</figcaption>
  </div>
