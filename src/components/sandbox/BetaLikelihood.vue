...
const xGrid = ref(seqn(-3, 3, 100)) 
const yGrid = ref(seqn(-3, 3, 100))
...
watchEffect(() => {
    ...
    tester.value ? 
    Plotly.react(tester.value, vuedata, layout, {displaylogo: false, responsive:true, displayModeBar:false,scrollZoom: false}) :
     null
})
