...
Folks have written about dividing the DOM between d3 and React, and this post isn't all that different conceptually, but you'll see more Vue related code here.

## Binding data to circles

We'll build this little demo in two different ways, the d3 way and the Vue way to understand some of the differences between the two.

### The d3 way
Starting with an empty svg element, we can add circles directly to the DOM using d3
...
These are implemented in the methods section of the Vue component, 
