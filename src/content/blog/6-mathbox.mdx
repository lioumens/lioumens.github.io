...
How do you draw an ellipse? There's the center and two radii, one for the *major* axis and one for the *minor* axis. The covariance matrix $\Sigma$ has all the information you need to draw the ellipse. The center of the ellipse is at $\bm{\mu}_\mathbf{z}$, and the radii are the square roots of the eigenvalues of $\Sigma$. The eigenvectors of $\Sigma$ are the directions of the major and minor axes.
